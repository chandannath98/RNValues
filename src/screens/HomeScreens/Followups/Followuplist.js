...
const Followupslist = ({ navigation }) => {
  const DealerList = useSelector(state => state.Customerlist.FollowupListData);
                ...
                >
                  ...
                  <View
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        onPress={() => openDialScreen(item.CreatorPhone)}>
                        <Text
                          style={{
                            color: '#00A9FF',
                            fontSize: 12,
